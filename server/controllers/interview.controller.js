...
- Keep language conversational and practical.
...
Rules:
- Weak answers should get low scores.
- Strong answers should get high scores.
- Be realistic and unbiased.

Calculate:
finalScore = average of all scores rounded to nearest whole number.
